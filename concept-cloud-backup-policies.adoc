...
此功能不会为源卷提供保护、仅会为这些源卷的备份提供保护。使用NetApp https://cloud.netapp.com/ci-sde-plp-cloud-secure-info-trial?hsCtaTracking=fefadff4-c195-4b6a-95e3-265d8ce7c0cd%7Cb696fdde-c026-4007-a39e-5e986c4d27c6["Cloud Insights 和Cloud Secure"^]或部分 https://docs.netapp.com/us-en/ontap/anti-ransomware/index.html["ONTAP 提供的反勒索软件保护"^] 以保护源卷。
...
NOTE: StorageGRID S3对象锁定功能提供了一个DataLock模式、相当于合规模式。不支持等效的监管模式、因此任何用户都无法绕过保留设置、覆盖受保护的备份或删除备份。
...
* 您必须使用Cloud Manager 3.9.21或更高版本
