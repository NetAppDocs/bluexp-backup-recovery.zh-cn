...
| 云部署 | 按照的说明进行操作 https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["正在连接到Connector Linux虚拟机"^] 取决于您使用的云提供商。 
