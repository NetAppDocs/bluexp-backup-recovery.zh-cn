...
* 您已在Azure中安装Connector。无论是否可访问 Internet ，均可将 Connector 安装在站点中。
...
--
连接器要求:: 无论是否可访问Internet、均可将Connector安装在Azure区域中。目前、不能访问Internet的站点仅支持Azure商业站点。
+
--
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["在无法访问Internet的Azure区域的Linux主机上安装Connector"^]
