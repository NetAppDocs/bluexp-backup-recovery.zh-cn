...
+
** 对于BlueXP备份和恢复PAYGO许可、您需要订阅 https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Azure 酒店"^] 使用BlueXP备份和恢复的BlueXP Marketplace产品。BlueXP备份和恢复的计费通过此订阅完成。
