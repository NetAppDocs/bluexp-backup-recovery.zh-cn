...
连接器要求:: 无论是否可访问Internet、均可将Connector安装在AWS区域中。目前、不能访问Internet的站点仅支持AWS商业站点。
+
--
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["在无法访问Internet的AWS区域的Linux主机上安装Connector"^]
