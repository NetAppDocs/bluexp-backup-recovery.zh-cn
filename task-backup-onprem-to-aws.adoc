...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html["在AWS中安装连接器"^]
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-on-prem.html["在内部安装Connector"^]
...
如果您要使用自己的客户管理密钥进行数据加密、而不是使用默认密钥、则在启动BlueXP备份和恢复向导之前、您需要先设置加密管理密钥。 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-setting-up-kms.html["了解如何使用您自己的密钥"^]。
...
.. 要存储备份的 AWS 区域。
.. 您是使用默认 Amazon S3 加密密钥，还是从 AWS 帐户中选择您自己的客户管理密钥来管理数据加密。 (https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-setting-up-kms.html["了解如何使用您自己的密钥"]）。
+
