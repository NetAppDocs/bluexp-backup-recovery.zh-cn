...
* link:concept-cloud-backup-policies.html#datalock-and-ransomware-protection["DataLock和防抱死锁保护的工作原理"]。
* link:manage-backup-settings-ontap.html["如何在"高级设置"页面中更新"反向软件"保护选项"]。
